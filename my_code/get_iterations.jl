function prepareSolIter(seed,N,Nout,qli, nb_iter, inst, sol, cost, expname)
    ...
    d["proba_tacticboat"] = sol.store.parameters.ChooseTacticTypeShip
    d["proba_tacticall"] = sol.store.parameters.ChooseTacticAllShip
    d["proba_tacticlocalsearch"] = sol.store.parameters.ChooseTacticLocalSearch
    d["proba_distanceboat"] = sol.store.parameters.DistanceTypeShip
    d["proba_costboat"] = sol.store.parameters.CostTypeShip
    d["proba_countall"] = sol.store.parameters.CountAllShip
    d["proba_costall"] = sol.store.parameters.CostAllShip
    d["proba_constrained"] = sol.store.parameters.RateConstrained
