...
function makeSolHeur(type1, type2, type3, paramfixed, temperature, time_local, max_time_heur, max_time, expname, location)
...
newbenchmark = makeSolHeur(type1, type2, type3, paramfixed, temperature, time_local, max_time_heur, max_time, expname, location)
CSV.write(location*"results_jobs/benchmarks_HEUR/orderedGRASPparam/$expname"*"/NLarge.csv", newbenchmark)
newbenchmark
