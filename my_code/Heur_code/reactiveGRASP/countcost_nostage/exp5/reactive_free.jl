...
function GRASP_reactive(seed,N,Nout,qli, type1, type2, adjustproba, alphaboat, alpharandom, time_local, max_time_heur, max_time, expname, location)
    ...
    while elapsed<max_time
        ...
        if feasible && checkSolutionFeasability(inst, new_sol)
            ...
            CSV.write(location*"results_jobs/benchmarks_HEUR/reactiveGRASP/countcost_nostage/$expname"*"/iterations_before_local/sol_$seed"*"_$N"*"_$Nout"*"_$qli"*"/iter_$nb_iter"*"_beforelocal"*".csv", d)
            ...
            CSV.write(location*"results_jobs/benchmarks_HEUR/reactiveGRASP/countcost_nostage/$expname"*"/iterations/sol_$seed"*"_$N"*"_$Nout"*"_$qli"*"/iter_$nb_iter"*".csv", d)
            nb_iter+=1
