function prepareSolIterSoft(seed,N,Nout,qli, nb_iter, inst, sol, cost, allparam, paramchosen, expname)
    ...
    d["pathrelinking"]=sol.relinking
    d["usedLocalSearch"]=sol.usedLocalSearch
